...
const toggleBtn = document.querySelector('header .icon-group .toogle_btn');
const menu = document.querySelector('header .main-menu-mobile');
const icons = document.querySelector('header .icon-group .material-icons');
